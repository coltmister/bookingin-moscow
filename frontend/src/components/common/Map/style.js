export default {
    ...
    sources: {
        openmaptiles: {
            type: 'vector',
            url: 'https://maps.admin47.ru/data/v3.json',
        },
    },
    sprite: 'https://maps.admin47.ru/styles/bright/sprite',
    glyphs: 'https://maps.admin47.ru/fonts/{fontstack}/{range}.pbf',
    layers: [
        {
            id: 'background',
            type: 'background',
