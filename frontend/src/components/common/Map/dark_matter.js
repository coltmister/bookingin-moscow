export default {
    ...
    sources: {
        openmaptiles: {
            type: 'vector',
            url: 'https://maps.bookingin.moscow/data/v3.json',
        },
    },
    sprite: 'https://maps.bookingin.moscow/styles/bright/sprite',
    glyphs: 'https://maps.bookingin.moscow/fonts/{fontstack}/{range}.pbf',
    layers: [
        {
            id: 'background',
            type: 'background',
            paint: { 'background-color': 'rgb(32,37,49)' },
        },
        {
            id: 'water',
            type: 'fill',
            ...
            paint: { 'fill-antialias': false, 'fill-color': 'rgb(9,24,43)' },
        },
        {
        ...
        },
        {
            ...
            layout: { visibility: 'visible' },
            paint: { 'fill-antialias': true, 'fill-color': 'rgba(40, 40, 60, 1)' },
        },
        {
            id: 'road_pier',
            type: 'line',
        ...
        },
        {
            ...
            'source-layer': 'poi',
            minzoom: 10,
            filter: ['all', ['==', '$type', 'Point'], ['>=', 'rank', 1], ['<', 'rank', 3]],
            layout: {
